...
public class Main {
    ...
    public static final String INFO_CREATE = "create [path] [file-name] - Создает текстовый файл по указанному пути;";
    public static final String INFO_READ = "read [path] [file-name] - Считывает файл по указанному пути и выводит текст в консоль;";
    public static final String INFO_INFO = "info [path] [file-name] - Выводит краткую информацию по указанному файлу;";
    public static final String INFO_HELP = "help - Выводит в консоль все доступные команды и информацию к ним;";
    public static final String INFO_HELP_COMMAND = "help [command] - Выводит в консоль информацию по указанной команде;";
    public static final String INFO_EXIT = "exit - Завершение работы программы.";
    ...
    public static void info(File file) {
        ...
        try (FileReader fileReader = new FileReader(file);
            ...
            info.append("Информация по файлу ").append("\'").append(file.getName()).append("\':\n")
                    ...
                    .append("Дата и время последнего изменения: ").append(dateFormat.format(file.lastModified())).append("\n")
    ...
    public static void noCommand (String someText) {
        ...
        switch (new Scanner(System.in).nextLine().toUpperCase()) {
            case "Y":
                ...
                System.out.println("Укажите в какой файл делать запись в формате [путь] [имя_файла]: ");
